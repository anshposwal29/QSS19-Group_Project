// chapters/chapter-syrup/chapter.js
...
export function createChapter() {
  ...
  function showScene(stepId) {
    _clearScene();
    switch (stepId) {
      case "syrup-table":  step1(); break;
      case "syrup-reveal": step2(); break;
      case "syrup-pfas":   step3(); break;
      case "syrup-zoom":   step4(); break;
      default: step1();
    }
  }
  ...
  // Step 4 — Too Small to See, Too Stable to Remove
  function step4() {
    _setBg("sg-dark");
